...
# ✅ TU VALIDACIÓN EXCLUSIVA - NO BAJA NADA DE NADIE
...
# ✅ TODOS LOS ARCHIVOS SE BAJAN DE TU REPOSITORIO
...
for arqx in $(echo $arch); do
  wget -O ${SCPinstal}/${arqx} ${lisArq}/${arqx} > /dev/null 2>&1 && {
    ...
    del 1
    print_center -verm2 'FALLA: $arqx'
    sleep 2s
    error_fun "${arqx}"
  }
done

# ✅ TODAS LAS HERRAMIENTAS TAMBIÉN DE TU REPOSITORIO
