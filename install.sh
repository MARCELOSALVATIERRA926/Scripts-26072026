...
# ==== CARPETAS Y RUTAS: TAL CUAL ESTABAN ====
...
if [[ $(which install-LIC) = "" ]]; then
  wget -O /usr/bin/install-LIC 'https://raw.githubusercontent.com/MARCELOSALVATIERRA926/Scripts-26072026/main/Rufu-LIC/install-LIC'; chmod +x /usr/bin/install-LIC &>/dev/null
fi
install-LIC
[[ $? = 1 ]] && exit
...
time_reboot(){
  # ✅ TEXTO MODIFICADO
  print_center -ama "REINICIANDO VPS EN $1 SEGUNDOS | FENIX-M&M"
  REBOOT_TIMEOUT="$1"
...
error_fun(){
  ...
  # ✅ TEXTO MODIFICADO
  print_center -ama "Reportar con el administrador @FENIX-M&M"
  msg -bar3
...
# ✅ LISTA DE ARCHIVOS DESDE TU REPOSITORIO
...
title -ama '[Proyecto FENIX-M&M]'
print_center -ama 'INSTALANDO SCRIPT FENIX-M&M'
sleep 2; del 1
...
# ✅ UTILIDADES DESDE TU REPOSITORIO
url='https://github.com/MARCELOSALVATIERRA926/Scripts-26072026/raw/main/Utils'
...
wget --no-cache -O /etc/ADMRufu/uninstall "https://github.com/MARCELOSALVATIERRA926/Scripts-26072026/raw/main/uninstall" &>/dev/null; chmod +x /etc/ADMRufu/uninstall
...
echo "@FENIX-M&M" > /etc/ADMRufu/tmp/message.txt

# ✅ MENSAJE FINAL MODIFICADO
title "-- FENIX-M&M INSTALADO --"
