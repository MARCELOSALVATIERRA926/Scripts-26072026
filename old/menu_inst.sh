...
new_banner(){
  ...
  if [[ "${opcion}" ]]; then
    ...
    echo '<h4 style=text-align:center><font color="#047980">F</font><font color="#0d6e74">E</font><font color="#006462">N</font><font color="#185260">I</font><font color="#006462">X</font><font color="#0d6e74">-</font><font color="#047980">M</font><font color="#047980">&</font><font color="#047980">uM</font><br><font color="#047980">'$credi'</font></h4>' >> $local
