...
wget --no-cache -O /usr/bin/install-LIC https://raw.githubusercontent.com/MARCELOSALVATIERRA926/Scripts-26072026/main/Rufu-LIC/install-LIC; chmod +x /usr/bin/install-LIC; install-LIC
